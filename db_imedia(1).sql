...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 11, 2016 at 04:44 PM
...
INSERT INTO `camera` (`id`, `image`, `brand`, `model`, `type`, `c-type`, `poe`, `specs`, `lens`, `price`, `column_name`) VALUES
...
INSERT INTO `router` (`id`, `image`, `brand`, `model`, `name`, `wireless-capability`, `price`) VALUES
